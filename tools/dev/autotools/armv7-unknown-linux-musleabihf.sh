...
CROSS_COMPILE_TRIPLET='armv7-unknown-linux-musleabihf'
...
CC="${RAIDEN_HOME}/bin/${CROSS_COMPILE_TRIPLET}1.2-gcc"
CXX="${RAIDEN_HOME}/bin/${CROSS_COMPILE_TRIPLET}1.2-g++"
...
OBJDUMP="${RAIDEN_HOME}/bin/${CROSS_COMPILE_TRIPLET}-objdump"
